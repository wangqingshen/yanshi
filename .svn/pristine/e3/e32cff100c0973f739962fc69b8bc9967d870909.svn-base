...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Yanshi','Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas'),
        'TMPL_DETECT_THEME'     => false,       // 自动侦测模板主题
        'TMPL_TEMPLATE_SUFFIX'  => '.html',     // 默认模板文件后缀
        'DEFAULT_MODULE'        =>  'Yanshi',  // 默认模块
...
//            '__TMPL__Public' => __ROOT__.'admin/themes/simplebootx/Public/'
        ),
        'order_state' => array(1=>'未付款',2=>'已付款',3=>'配送中',4=>'已送达',5=>'已完成',6=>'拼团未付款',7=>'拼团个人已付款',8=>'拼团付款完成'),
        'order_type'  => array(1=>'普通商品',2=>'2人拼团商品',3=>'4人拼团'),
        'delivery_time' => array(1=>'午餐',2=>'晚餐'),
        'time_area' => array(
            'noon' => array(
                1 => '11点~11点30',
                2 => '11点30~12点',
